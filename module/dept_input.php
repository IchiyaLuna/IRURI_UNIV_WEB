<div class="collapse multi-collapse-dept" id="dept-input">
    ...
    <div class="grade-input-dept collapse show" id="grade-input-dept">
        <div class="card card-body">
            동의를 선택해야 성적을 입력하실 수 있습니다.
        </div>
    </div>

    <div class="grade-input-dept collapse" id="grade-input-dept">
        <div class="card card-body">
                    ...
                    <div class="row gy-3">
                        <div class="col-xl-3 first-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control form-control-sm text-center" name="dept-first" id="dept-first" placeholder="1.0">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 second-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control form-control-sm text-center" name="dept-second" id="dept-second" placeholder="1.0">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 third-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control form-control-sm text-center" name="dept-third" id="dept-third" placeholder="1.0">
                            </div>
                        </div>
