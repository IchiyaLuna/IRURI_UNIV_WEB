                ...
                <div class="categorysel py-3">
                    <div class="row gy-3">
                        <div class="col-md-12 mb-3">
                            <select class="form-select" name="category" id="category" size="5">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-select" id="dept-year" name="dept-year">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-select" id="dept-month" name="dept-month">
                                            <option value="-1" selected>응시하지 않음</option>
