                    ...
                    <div class="row align-items-md-stretch">
                        <div class="col-md-6">
                            <div class="h-100 p-5 text-white bg-dark border rounded-3 position-relative">
                                ...
                                <a href="#" class="btn btn-primary stretched-link" data-bs-toggle="collapse" href="#university-input" role="button">학교 보러가기</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="h-100 p-5 bg-light border rounded-3 position-relative">
                                ...
                                <a href="#" class="btn btn-primary stretched-link" data-bs-toggle="collapse" href="#department-input" role="button">학과 보러가기</a>
                            </div>
                        </div>
                    </div>
