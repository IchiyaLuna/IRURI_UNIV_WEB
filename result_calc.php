        ...
        <div class="container-fluid px-4">
            ...
            <div class='row'>
                ...
                <div class="content-main col-md-8 bg-light border rounded-3">
                        ...
                        <table class="table mb-0 table-hover">
                            ...
                            <tbody>
                                ...
                                foreach ($subjects as $data) {
                                    ...
                                    echo "<td class='text-danger'>" . $data[5] . "등급" . "</td>";
                    ...
                    <button type="button" class="btn btn-warning" onclick="window.location.reload();"><i class="fas fa-redo-alt"></i>다시 계산하기</button>
                </div>
